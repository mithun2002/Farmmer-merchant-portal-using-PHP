	...
	?>
		...
		<div class="footer-center">
			<div>
				...
				<p style="font-size:20px">Agro Culture<span>Mithunraj</span></p>
			</div>
			<div>
				<i class="fa fa-phone"></i>
				<p style="font-size:20px">9042888737</p>
			</div>
			<div>
				<i class="fa fa-envelope"></i>
				<p style="font-size:20px"><a href="mailto:agroculture@gmail.com" style="color:white">agroculture2002@gmail.com</a></p>
			</div>
		</div>
		...
		<div class="footer-right">
			<p class="footer-company-about" style="color:white">
				...
				AgroCulture is e-commerce trading platform  between farmer and merchant
			</p>
